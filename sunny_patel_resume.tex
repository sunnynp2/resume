...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Refined the virtual golden image for developer environments, ensuring compliance with package and security requirements, resulting in a 2-hour reduction in setup time per deployment.}
        \resumeItem{Developed Python and C++ scripts in a Linux environment for airplane equipment testing at Collins Aerospace} 
        \resumeItem{Provided active in-person support to test engineers for requirement-based testing}
        \resumeItem{Implemented a precision timing algorithm that calculates time delay between sending and receiving messages on an IRIG system}
        \resumeItem{Improved database functionality by 33\% to software/hardware integration scripts}
...
\section{Projects}
  \resumeSubHeadingListStart
    \resumeProjectheading
      {Ecommerce Website}{Nov 2023 -- Jul 2023}
      \resumeItemListStart
